...
local Event = game:GetService("ReplicatedStorage").TycoonRemotes.VirusCatchTry
Event:FireServer(
    "4"
)
...
local Event = game:GetService("ReplicatedStorage").TycoonRemotes.VirusSpawn
...
local Event = game:GetService("ReplicatedStorage").MinigameRemotes.MgHack
Event:FireServer()
]]
