...
Connections.PopupAdded = LocalPlayer.CharacterAdded:Connect(function(text)
	for _, key in ipairs(
		Values.EggZone = 
end)
...
local Event = game:GetService("ReplicatedStorage").Remotes.Popup
firesignal(Event.OnClientEvent, 
    "Mines\xF0\x9F\x98\xB0",
    Color3.new(0.4705882370472, 0.4705882370472, 0.50980395078659),
    {
        Direction = "left",
        DelayBetween = 1.5,
        Effect = "Shine"
