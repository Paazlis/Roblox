    ...
    {
        {
            ...
            LeafIndex = 623,
            AreaName = "Front Yard",
            Position = Vector3.new(-63.133071899414, 0.35000398755074, -5.5662622451782)
        },
        {
            IsLucky = false,
            LeafIndex = 974,
            AreaName = "Front Yard",
            Position = Vector3.new(-63.089561462402, 0.35000398755074, -6.7100667953491)
        }
    }
)

workspace.LeafFolder:GetChildren()[1791] -- AreaName, LeafIndex Attribute | .CFrame.Position
workspace.LeafFolder
]]
