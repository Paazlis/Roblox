...
local function FireMinigame()
	if MinigameFrame.Visible == true and Enableds.Hack then
		Packets.MinigameHackableTap:FireServer()
	end
end
...
local function HandleHack()
	...
	Packets.MinigameHackableTap = Packets.MinigameHackableTap or ReplicatedStorage:QueryDescendants("#MinigameRemotes > #MgHack")[1]
